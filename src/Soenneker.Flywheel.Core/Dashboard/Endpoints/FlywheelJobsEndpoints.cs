...
public static class FlywheelJobsEndpoints
{
    internal static void Map(RouteGroupBuilder group)
    {
        group.MapPost("/jobs/schedules/{id}/run", RunRecurring)
            ...
            .Produces<StartedJob>(StatusCodes.Status200OK)
        ...
        group.MapGet("/jobs/history", History)
            ...
            .Produces<IReadOnlyList<JobHistoryPoint>>(StatusCodes.Status200OK)
            .Produces(StatusCodes.Status400BadRequest)
            .Produces(StatusCodes.Status501NotImplemented)
            .Produces(StatusCodes.Status401Unauthorized)
            .Produces(StatusCodes.Status403Forbidden);
        ...
        group.MapGet("/jobs/history/options", HistoryOptions)
            ...
            .Produces<HistoryOptions>(StatusCodes.Status200OK)
            .Produces(StatusCodes.Status501NotImplemented)
            .Produces(StatusCodes.Status401Unauthorized)
            .Produces(StatusCodes.Status403Forbidden);
        group.MapGet("/jobs/schedules", Schedules)
            ...
            .Produces<ScheduleView>(StatusCodes.Status200OK)
            .Produces(StatusCodes.Status501NotImplemented)
            .Produces(StatusCodes.Status401Unauthorized)
            .Produces(StatusCodes.Status403Forbidden);
        group.MapGet("/jobs", List)
            ...
            .Produces<IEnumerable<JobView>>(StatusCodes.Status200OK)
            .Produces(StatusCodes.Status400BadRequest)
            .Produces(StatusCodes.Status401Unauthorized)
            .Produces(StatusCodes.Status403Forbidden);
        ...
        group.MapGet("/jobs/{id}", Get)
            ...
            .Produces<JobView>(StatusCodes.Status200OK)
            .Produces(StatusCodes.Status400BadRequest)
            .Produces(StatusCodes.Status404NotFound)
            .Produces(StatusCodes.Status401Unauthorized)
            .Produces(StatusCodes.Status403Forbidden);
