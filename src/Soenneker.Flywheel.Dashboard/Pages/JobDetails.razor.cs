...
public partial class JobDetails
{
    ...
    private async Task Reload()
    {
        ...
        try
        {
            var response = await Consumer.GetJob(id, CancellationToken);
            if (id != JobId) return;
    ...
    private async Task Cancel()
    {
        ...
        try
        {
            var response = await Consumer.CancelJob(JobId, CancellationToken);
