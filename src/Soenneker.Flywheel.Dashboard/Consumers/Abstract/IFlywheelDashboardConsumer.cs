...
{
    /// <summary>Reads the authenticated dashboard identity.</summary>
    ValueTask<OperationResult<DashboardUser>> GetUser(CancellationToken cancellationToken = default) => throw new NotSupportedException();
